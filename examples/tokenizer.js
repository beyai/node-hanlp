...
// [Tokenizer 标准分词]
console.log("\n============================= 标准分词 =============================")
var words = HanLP.Tokenizer("商品和服务");
console.log(words)

// [NLPTokenizer NLP分词]
console.log("\n============================= NLP分词 =============================")
var words = HanLP.NLPTokenizer("中国科学院计算技术研究所的宗成庆教授正在教授自然语言处理课程");
console.log(words)

// [IndexTokenizer 索引分词]
console.log("\n============================= 索引分词 =============================")
var words = HanLP.IndexTokenizer("主副食品");
console.log(words)


// [ShortSegment 最短路分词]
console.log("\n============================= 最短路分词 =============================")
var words = HanLP.ShortSegment( "今天，刘志军案的关键人物,山西女商人丁书苗在市二中院出庭受审。" );
console.log(words)

// [NShortSegment N-最短分词]
console.log("\n============================= N-最短分词 =============================")
var words = HanLP.NShortSegment( "刘喜杰石国祥会见吴亚琴先进事迹报告团成员" );
console.log(words)

// [SpeedTokenizer 极速词典分词]
console.log("\n============================= 极速词典分词 =============================")
var words = HanLP.SpeedTokenizer( "江西鄱阳湖干枯，中国最大淡水湖变成大草原" );
console.log(words)
...
console.log("\n============================= CRF分词 =============================")
text.forEach( ( item ) => {
	var words = HanLP.CRFTokenizer( item );
	console.log(words)
})
